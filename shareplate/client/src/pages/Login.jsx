    ...
    <div className="min-h-screen flex bg-gray-50">
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-brand-600 to-brand-900 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-20 w-64 h-64 bg-accent-300 rounded-full blur-3xl" />
        </div>
        <div className="relative text-white max-w-md text-center">
          <Leaf className="w-16 h-16 mx-auto mb-6 opacity-80" />
          <h2 className="text-4xl font-bold font-display mb-4">Welcome Back!</h2>
          <p className="text-brand-100 text-lg">Continue your journey to reduce food waste and feed those in need.</p>
        </div>
      </div>
      <div className="flex-1 flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Welcome back to SharePlate</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? 'text' : 'password'} className="input-field pr-10" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} required />
