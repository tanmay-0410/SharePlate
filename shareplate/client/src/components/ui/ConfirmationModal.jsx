...
export default function ConfirmationModal({ open, onClose, onConfirm, title = "Confirm Donation", children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="absolute inset-0 bg-black/[0.40]" onClick={onClose} />
      <div className="relative bg-white/[0.90] backdrop-blur rounded-xl p-6 w-full max-w-lg shadow-lg z-10">
